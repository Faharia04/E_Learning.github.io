      ...
      <div class="vid-content" >
        ...
        <?php    
              if(!isset($_SESSION['is_login'])){
                echo '<a class="btn btn-dark mt-3" href="#" data-toggle="modal" data-target="#stuRegModalCenter">Get Started</a>';
              } else {
              ...
              echo '
                <a href="coursedetails.php?course_id='.$course_id.'"  class="btn" style="text-align: left; padding:0px;">
                  <div class="card">
                    ...
                    <div class="card-footer">
                      <p class="card-text d-inline">Price: <small><del>&#x9F3 '.$row['course_original_price'].'</del></small> <span class="font-weight-bolder">&#x9F3 '.$row['course_price'].'<span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="#">Enroll</a>
                    </div>
                  </div>
                </a>  ';
            }
